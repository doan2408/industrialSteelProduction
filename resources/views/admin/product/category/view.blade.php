...
<script>
    var url_delete = "{{route('post-delete-product-cate')}}";
    var url_update_position = "{{route('post-update-product-cate')}}";
</script>
@endsection
@section("js")
		...
		<div class="row">
			<div class="col-sm-6">
				...
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item"><a href="{{route('view-product-cate')}}">Nhóm sản phẩm</a></li>
					<li class="breadcrumb-item active">Danh sách</li>
				</ol>
			</div>
			<div class="col-sm-6">
					<a href="{{route('add-product-cate')}}" class="btn btn-primary w-md">Thêm</a>
											...
											<li class="dd-item dd3-item" data-id="{{$item->id}}">
												...
												<div class="dd3-content">
													...
													<span class="action_menu">
														<a href="{{route('edit-product-cate',$item->id)}}" class=""><i class="fa fa-pencil"></i></a>
														<a href="javascript:void(0);" class="delete_row_table" data-id="{{$item->id}}"><i class="fa fa-trash"></i></a>     
													</span>
												...
												if ($check_child_1 > 0) {
													...
													foreach ($data as $item1) {													
														...
														<li class="dd-item dd3-item" data-id="{{$item1->id}}">
															<div class="dd-handle dd3-handle"></div>
															<div class="dd3-content">
																{{\Str::limit($item1->name,40,'...')}}
																<span class="action_menu">
																	<a href="{{route('edit-product-cate',$item1->id)}}" class=""><i class="fa fa-pencil"></i></a>
																	<a href="javascript:void(0);" class="delete_row_table" data-id="{{$item1->id}}"><i class="fa fa-trash"></i></a>     
																</span>
															...
															if ($check_child_2 > 0) {
																...
																foreach ($data as $item2) {
																	...
																	<li class="dd-item dd3-item" data-id="{{$item2->id}}">
																		<div class="dd-handle dd3-handle"></div>
																		<div class="dd3-content">
																			{{\Str::limit($item2->name,40,'...')}}
																			<span class="action_menu">
																				<a href="{{route('edit-product-cate',$item2->id)}}" class=""><i class="fa fa-pencil"></i></a>
																				<a href="javascript:void(0);" class="delete_row_table" data-id="{{$item2->id}}"><i class="fa fa-trash"></i></a>
																			</span>
