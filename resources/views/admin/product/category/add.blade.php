...
<div class="container-fluid">
	<form class="form-wizard" method="post" action="{{route('post-add-product-cate')}}" enctype="multipart/form-data">
		@csrf
								...
								<div class="row">
									...
									<div class="col-12 col-lg-12">
										<div class="mb-3">
											...
											{{Form::textarea('content','',array('class'=>'form-control tinymce_editor'))}}
										</div>
									</div>
