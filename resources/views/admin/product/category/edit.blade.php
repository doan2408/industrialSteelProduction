...
<script src="{{asset('assets/admin')}}/assets/js/jscolor.js"></script>
		...
		<div class="row">
			<div class="col-sm-6">
				...
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item"><a href="{{route('view-product-cate')}}">Nhóm sảm phẩm</a></li>
...
<div class="container-fluid">
	<form class="form-wizard" method="post" action="{{route('post-edit-product-cate',$data->id)}}" enctype="multipart/form-data">
		@csrf
								...
								<div class="row">
									...
									<div class="col-12 col-lg-12">
										<div class="mb-3">
											...
											{{Form::textarea('content',$data->content,array('class'=>'form-control tinymce_editor'))}}
										</div>
									</div>	
								</div>
							</div>
