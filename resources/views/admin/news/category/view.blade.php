...
<script>
    var url_delete = "{{route('post-delete-news-cate')}}";
    var url_update_position = "{{route('post-update-news-cate')}}";
</script>
@endsection
@section("js")
		...
		<div class="row">
			<div class="col-sm-6">
				...
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item"><a href="{{route('view-news-cate')}}">Nhóm tin tức</a></li>
					<li class="breadcrumb-item active">Danh sách</li>
				</ol>
			</div>
			<div class="col-sm-6">
				<a href="{{route('add-news-cate')}}" class="btn btn-primary w-md">Thêm</a>
			</div>
		</div>
	</div>
</div>
											...
											<li class="dd-item dd3-item" data-id="{{$item->id}}">
												...
												<div class="dd3-content">
													...
													<span class="action_menu">
														<a href="{{route('edit-news-cate',$item->id)}}" class=""><i class="fa fa-pencil"></i></a>
													...
													foreach ($data as $item1) {													
														...
														<li class="dd-item dd3-item" data-id="{{$item1->id}}">
															...
															<div class="dd3-content">
																...
																<span class="action_menu">
																	<a href="{{route('edit-news-cate',$item1->id)}}" class=""><i class="fa fa-pencil"></i></a>
																...
																foreach ($data as $item2) {
																	...
																	<li class="dd-item dd3-item" data-id="{{$item2->id}}">
																		...
																		<div class="dd3-content">
																			...
																			<span class="action_menu">
																				<a href="{{route('edit-news-cate',$item2->id)}}" class=""><i class="fa fa-pencil"></i></a>
