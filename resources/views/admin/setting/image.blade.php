					...
					<div class="card-body">
						...
						<div class="row">
							<div class="col-12 col-lg-12">
								<div class="mb-3">
									<label class="form-label">Logo <img src="@if(isset($data->website_logo)){{$data->website_logo}}@endif" width="100px" id="img_website_logo"/></label>	
									<input style="display:none" class="form-control file_upload_server_custom" id="label_website_logo" type="file" data-img="img_website_logo" data-id="website_logo" data-url="{{route('dashboard-upload-one')}}" accept="image/*">
									<div class="input-group"><label style="margin-bottom:0px;" class="input-group-text" for="label_website_logo">Upload file</label>
										{{Form::text('website_logo',isset($data->website_logo) ? $data->website_logo: '',array('class'=>'form-control input-group-air ','id'=>'website_logo'))}}
									</div>
								</div>
							</div>
						</div>
