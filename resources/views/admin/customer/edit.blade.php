		...
		<div class="row">
			<div class="col-sm-6">
				...
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item"><a href="{{route('view-customer')}}">Khách hàng</a></li>
...
<div class="container-fluid">
	<form class="form-wizard" method="post" action="{{route('post-edit-customer')}}" enctype="multipart/form-data">
							@csrf
	<!-- start page title -->
						...
						@include('admin.alert')
							...
							<div class="row">	
								<div class="col-12 col-lg-12">
									<div class="mb-3">
										<label class="form-label">Ảnh 100x100<img id="avatar_img" src="{{$data->avatar}}" width="100px"/></label>	
