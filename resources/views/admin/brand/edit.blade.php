		...
		<div class="row">
			<div class="col-sm-6">
				...
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item"><a href="{{route('view-brand')}}">Thương hiệu</a></li>
...
<div class="container-fluid">
	<form class="form-wizard" method="post" action="{{route('post-edit-brand')}}" enctype="multipart/form-data">
							@csrf
	<!-- start page title -->
