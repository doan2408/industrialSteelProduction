...
<div class="container-fluid">
	<form class="form-wizard" method="post" action="{{route('post-edit-project')}}" enctype="multipart/form-data">
							@csrf
	<!-- start page title -->
						...
						@include('admin.alert')
							...
							<div class="row">
								<div class="col-12 col-lg-12">
									<div class="mb-3">
										<label class="form-label">Ảnh 339x603 <img id="avatar_img" src="{{$data->avatar}}" width="100px"/></label>	
								...
								<div class="col-12 col-lg-3">
									<div class="mb-3">
										...
										{{Form::text('dimension',$data->dimension,array('class'=>'form-control'))}}
									</div>
								</div>
								<div class="col-12 col-lg-3">
									<div class="mb-3">
								...
								<div class="col-12 col-lg-12">
									<div class="mb-3">
										...
										<select class="js-example-placeholder-multiple" name="product_id[]" multiple>
											...
											<option value="{{$item->id}}" @if(in_array($item->id,$list_p)) selected @endif>{{$item->name}}</option>												
											@endforeach												
											@endif
										</select>
									</div>
						...
						<div class="card">
							<div class="card-body">
								<div class="row">
									<div class="col-12 col-lg-12">
										<div class="mb-3">
											<label class="form-label">Ảnh 1 696x200 <img id="image1_img" src="{{$data->image1}}" width="100px"/></label>	
											...
											<div class="input-group"><label style="margin-bottom:0px;" class="input-group-text" for="label_modal_image1">Upload file</label>
												{{Form::text('image1',$data->image1,array('class'=>'form-control input-group-air ','id'=>'image1'))}}
											</div>
										</div>
									</div>
									<div class="col-12 col-lg-12">
										<div class="mb-3">
											<label class="form-label">Ảnh 2 336x200 <img id="image2_img" src="{{$data->image2}}" width="100px"/></label>	
											...
											<div class="input-group"><label style="margin-bottom:0px;" class="input-group-text" for="label_modal_image2">Upload file</label>
												{{Form::text('image2',$data->image2,array('class'=>'form-control input-group-air ','id'=>'image2'))}}
											</div>
										</div>
									</div>
									<div class="col-12 col-lg-12">
										<div class="mb-3">
											<label class="form-label">Ảnh 3 336x200 <img id="image3_img" src="{{$data->image3}}" width="100px"/></label>	
											...
											<div class="input-group"><label style="margin-bottom:0px;" class="input-group-text" for="label_modal_image3">Upload file</label>
												{{Form::text('image3',$data->image3,array('class'=>'form-control input-group-air ','id'=>'image3'))}}
											</div>
										</div>
									</div>
									<div class="col-12 col-lg-12">
										<div class="mb-3">
											<label class="form-label">Ảnh 4 696x200 <img id="image4_img" src="{{$data->image4}}" width="100px"/></label>	
											...
											<div class="input-group"><label style="margin-bottom:0px;" class="input-group-text" for="label_modal_image4">Upload file</label>
												{{Form::text('image4',$data->image4,array('class'=>'form-control input-group-air ','id'=>'image4'))}}
											</div>
										</div>
									</div>
									<div class="col-12 col-lg-12">
										<div class="mb-3">
											<label class="form-label">Ảnh 5 696x200 <img id="image5_img" src="{{$data->image5}}" width="100px"/></label>	
											...
											<div class="input-group"><label style="margin-bottom:0px;" class="input-group-text" for="label_modal_image5">Upload file</label>
												{{Form::text('image5',$data->image5,array('class'=>'form-control input-group-air ','id'=>'image5'))}}
											</div>
										</div>
									</div>
								</div>
