		...
		var table = $('#example').DataTable({
			...
			"columns": [{
					...
					"render": function(data, type, row, meta) {
						...
						return 'Email: '+data.email+'<br/>Tên: '+data.name
		...
		<div class="row">
			<div class="col-sm-6">
				...
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item"><a href="{{route('view-user')}}">Tài khoản</a></li>
					<li class="breadcrumb-item active">Danh sách</li>
				</ol>
			</div>
			<div class="col-sm-6">
				<a href="{{route('add-user')}}" class="btn btn-primary w-md">Thêm</a>
