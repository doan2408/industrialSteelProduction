...
<div class="container-fluid">
	<form class="form-wizard" method="post" action="{{route('post-add-student')}}" enctype="multipart/form-data">
		@csrf
								...
								<div class="row">			
									<div class="col-12 col-lg-12">
										<div class="mb-3">
											...
											<input style="display:none" class="form-control file_upload_server_custom" id="label_modal_avatar" type="file" data-id="avatar" data-url="{{route('dashboard-upload-one')}}" accept="image/*">
