...
@section('js')
    ...
    <script src="{{ asset('assets/admin') }}/assets/js/datepicker/date-time-picker/tempusdominus-bootstrap-4.min.js">
    </script>
...
@section('content')
            ...
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('view-student') }}">Sinh viên</a></li>
    ...
    <div class="container-fluid">
        <form class="form-wizard" method="post" action="{{ route('post-edit-student') }}" enctype="multipart/form-data">
            @csrf
            <!-- start page title -->
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-lg-12">
                                            <div class="mb-3">
                                                <label class="form-label">Ảnh 100x100<img id="avatar_img"
                                                        src="{{ $data->avatar }}" width="100px" /></label>
                                                <input style="display:none" class="form-control file_upload_server_custom"
                                                    ...
                                                    data-url="{{ route('dashboard-upload-one') }}" accept="image/*">
                                                <div class="input-group"><label style="margin-bottom:0px;"
                                                        class="input-group-text" for="label_avatar">Upload file</label>
                                                    {{ Form::text('avatar', $data->avatar, ['class' => 'form-control input-group-air ', 'id' => 'avatar']) }}
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12 col-lg-12">
                                            <div class="mb-3">
                                                ...
                                                {{ Form::text('full_name', $data->full_name, ['class' => 'form-control']) }}
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12 col-lg-12">
                                            <div class="mb-3">
                                                ...
                                                {{ Form::text('class_name', $data->class_name, ['class' => 'form-control']) }}
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12 col-lg-12">
                                            <div class="mb-3">
                                                ...
                                                {{ Form::select('status', ['0' => 'Không hoạt động', '1' => 'Hoạt động'], $data->status, [
                                                    'class' => 'form-control',
                                                ]) }}
                                            </div>
                                        </div>
