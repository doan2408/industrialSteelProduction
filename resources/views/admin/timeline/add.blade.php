...
<div class="container-fluid">
	<form class="form-wizard" method="post" action="{{route('post-add-timeline')}}" enctype="multipart/form-data">
		@csrf
								...
								<div class="row">
									...
									<div class="col-12 col-lg-6">
										<div class="mb-3">
											...
											{{Form::text('year',date('d/m/Y'),array('class'=>'form-control datepicker-here form-control digits','data-language'=>'en'))}}
										</div>
									</div>
