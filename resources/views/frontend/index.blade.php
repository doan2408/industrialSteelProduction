...
<div class="page-content bg-white">
					...
					<div id="rev_slider_1175_1" class="rev_slider fullscreenbanner" style="display:none;"
						...
						<ul>
							...
							<li data-index="rs-3239" data-transition="fade" data-slotamount="default"
								...
								data-thumb="{{App\Models\CommonModel::get_setting('website_banner1')}}" data-rotate="0" data-fstransition="fade"
								...
								<!-- MAIN IMAGE -->
								<img src="{{App\Models\CommonModel::get_setting('website_banner1')}}" alt="image" data-lazyload="{{App\Models\CommonModel::get_setting('website_banner1')}}"
								...
								<div class="rs-background-video-layer" data-forcerewind="on" data-volume="mute"
									...
									data-videomp4="{{App\Models\CommonModel::get_setting('website_video')}}" data-videopreload="auto"
								...
								<div class="tp-caption   rs-parallaxlevel-4" id="slide-3239-layer-1"
									...
									{!!App\Models\CommonModel::get_setting('setting_website_home1')!!}
								</div>
							</li>
							<!-- SLIDE  -->
						</ul>
	...
	<div class="content-block">
		...
		<div class="section-full content-inner-2 bg-primary wow fadeIn" data-wow-duration="2s"
					data-wow-delay="0.2s" style="background-image:url({{asset('assets/frontend')}}/images/background/map-bg.png);">
			<div class="container">
				<div class="row">
					<div class="col-lg-12 text-center service-info">
						<h2 class="title text-white">{{App\Models\CommonModel::get_setting('setting_website_home5')}}
						</h2>
						<p>{{App\Models\CommonModel::get_setting('setting_website_home6')}}
						</p>
					</div>
				</div>
			</div>
		...
		<div class="section-full content-inner">
			<div class="container">
				<div class="section-head text-center">
					<h2 class="title">{{App\Models\CommonModel::get_setting('setting_website_home7')}}</h2>
					<p>
						{{App\Models\CommonModel::get_setting('setting_website_home8')}}
					</p>
				</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-9 text-white">
						<h2 class="title">{{App\Models\CommonModel::get_setting('setting_website_home11')}}</h2>
					</div>
		...
		<div class="section-full section-project content-inner bg-gray wow fadeInUp" data-wow-duration="2s"
			...
			<div class="container">
				<div class="section-head text-black text-center">
					<h2 class="title">{{App\Models\CommonModel::get_setting('setting_website_home12')}}</h2>
					<p>{{App\Models\CommonModel::get_setting('setting_website_home13')}}</p>
				</div>
				<div class="row">
							...
							<div class="item">
								<div class="dlab-box project-bx">
									<div class="dlab-media radius-sm dlab-img-overlay1 dlab-img-effect zoom">
										<a href="{{route('detail', $item->slug)}}"><img src="{{$item->avatar}}"
												alt="{{$item->name}}"></a>
									</div>
									<div class="dlab-info">
										<h5 class="dlab-title">
			...
			<div class="container">
				<div class="grid-content">
					<div class="large-ads">
						...
						<img src="{{App\Models\CommonModel::get_setting('website_banner5')}}" alt="image">
						<div class="ads-info">
							<p>{{App\Models\CommonModel::get_setting('setting_website_home14')}}</p>
							<h3>{{App\Models\CommonModel::get_setting('setting_website_home15')}}
							</h3>
							<a href="{{App\Models\CommonModel::get_setting('setting_website_home16')}}" class="site-button btnhover20">Xem chi tiết</a>
						</div>
					</div>
					<div class="small-ads">
						<a href="{{App\Models\CommonModel::get_setting('setting_website_home19')}}">
							<div class="overlay"></div>
							<img src="{{App\Models\CommonModel::get_setting('website_banner6')}}" alt="image">
							<div class="ads-info">
								<p>{{App\Models\CommonModel::get_setting('setting_website_home17')}}</p>
								<h3>{{App\Models\CommonModel::get_setting('setting_website_home18')}}</h3>
							</div>
						</a>
						<a href="{{App\Models\CommonModel::get_setting('setting_website_home22')}}">
							<div class="overlay"></div>
							<img src="{{App\Models\CommonModel::get_setting('website_banner7')}}" alt="image">
							<div class="ads-info">
								<p>{{App\Models\CommonModel::get_setting('setting_website_home20')}}</p>
								<h3>{{App\Models\CommonModel::get_setting('setting_website_home21')}}</h3>
							</div>
						</a>
					</div>
				</div>
		...
		<div class="section-full bg-gray dlab-we-find content-inner bg-img-fix wow fadeIn"
			...
			<div class="container">
				<div class="section-head text-center">
					<h2 class="title">{{App\Models\CommonModel::get_setting('setting_website_home23')}}</h2>
					<p>
						{{App\Models\CommonModel::get_setting('setting_website_home24')}}
					</p>
				</div>
		...
		<div class="section-full content-inner wow fadeIn" data-wow-duration="2s" data-wow-delay="0.6s">
			<div class="container">
				<div class="section-head text-black text-center">
					<h2 class="title">{{App\Models\CommonModel::get_setting('setting_website_home25')}}</h2>
					<p>{{App\Models\CommonModel::get_setting('setting_website_home26')}}</p>
				</div>
		...
		<div class="section-full bg-gray dlab-we-find content-inner bg-img-fix wow fadeIn"
			...
			<div class="container">
				<div class="section-head text-center">
					<h2 class="title">{{App\Models\CommonModel::get_setting('setting_website_home27')}}</h2>
					<p>
						{{App\Models\CommonModel::get_setting('setting_website_home28')}}
					</p>
				</div>
				<div class="section-content">
					<div
