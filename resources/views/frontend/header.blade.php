			...
			<div class="container clearfix">
				<div class="d-flex align-items-center justify-content-between">
					<div class="logo-header mostion logo-white">
						<a href="{{asset('')}}">
							<img src="{{App\Models\CommonModel::get_setting('website_logo')}}" alt="image">
						</a>
					</div>

					<div class="header-nav navbar-collapse collapse justify-content-center">
						<div class="logo-header d-md-block d-lg-none">
							<a href="{{asset('')}}"><img src="{{App\Models\CommonModel::get_setting('website_logo')}}" alt="image"></a>
						...
						<ul class="nav navbar-nav">
							...
							?>
							<li>
								<a href="{{$i_menu->url}}">{{$i_menu->name}}  @if($check_1 == true)<i class="fas fa-chevron-down"></i>@endif</a>
								@if($check_1 == true)
								<ul class="sub-menu tab-content">
									...
									?>
									<li>
										<a href="{{$i_menu1->url}}">{{$i_menu1->name}} 
											@if($check_2 == true)<i class="fas fa-angle-right"></i>@endif
										</a>
										@if($check_2 == true)
										<ul class="sub-menu">
											@foreach($menu as $i_menu2)
											@if($i_menu2->parent_id == $i_menu1->id)
											<li><a href="{{$i_menu2->url}}" class="nav-link">{{$i_menu2->name}}</a></li>
											@endif
											@endforeach
										</ul>
										@endif
