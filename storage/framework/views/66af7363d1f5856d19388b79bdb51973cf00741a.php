...
<script>
    var url_delete = "<?php echo e(route('post-delete-news-cate')); ?>";
    var url_update_position = "<?php echo e(route('post-update-news-cate')); ?>";
</script>
		...
		<div class="row">
			<div class="col-sm-6">
				...
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item"><a href="<?php echo e(route('view-news-cate')); ?>">Nhóm tin tức</a></li>
					<li class="breadcrumb-item active">Danh sách</li>
				</ol>
			</div>
			<div class="col-sm-6">
				<a href="<?php echo e(route('add-news-cate')); ?>" class="btn btn-primary w-md">Thêm</a>
			</div>
		</div>
	</div>
</div>
											...
											<li class="dd-item dd3-item" data-id="<?php echo e($item->id); ?>">
												...
												<div class="dd3-content">
													...
													<span class="action_menu">
														<a href="<?php echo e(route('edit-news-cate',$item->id)); ?>" class=""><i class="fa fa-pencil"></i></a>
													...
													foreach ($data as $item1) {													
														...
														<li class="dd-item dd3-item" data-id="<?php echo e($item1->id); ?>">
															...
															<div class="dd3-content">
																...
																<span class="action_menu">
																	<a href="<?php echo e(route('edit-news-cate',$item1->id)); ?>" class=""><i class="fa fa-pencil"></i></a>
																...
																foreach ($data as $item2) {
																	...
																	<li class="dd-item dd3-item" data-id="<?php echo e($item2->id); ?>">
																		...
																		<div class="dd3-content">
																			...
																			<span class="action_menu">
																				<a href="<?php echo e(route('edit-news-cate',$item2->id)); ?>" class=""><i class="fa fa-pencil"></i></a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("admin.layout.hometemplate", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\wamp64\www\htc\resources\views/admin/news/category/view.blade.php ENDPATH**/ ?>