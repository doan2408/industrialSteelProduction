...
<script>
    var url_update_position = "<?php echo e(route('post-quick-edit')); ?>";
</script>
					...
					<div class="row">
						<div class="col-12 col-lg-12">
							<div class="mb-3">
								...
								<input id="name_group" class="form-control" data-link="<?php echo e(route('post-rename-group')); ?>" name="name_group" type="text" value="<?php echo e($data->name); ?>">
						...
						<div class="col-lg-12">
							<div class="form-group m-form__group row">
								<div class="col-lg-8" id="content_menu_edit">
									<?php echo $__env->make('admin.menu.ajax', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
								</div>
								<div  class="col-lg-4">
									<h4>Thêm menu</h4>
									<form method="post" action="<?php echo e(route('post-quick-add')); ?>" id="form_add_menu">
									<?php echo csrf_field(); ?>
									<input type="hidden" id="group_id" name="group_id" value="<?php echo e($data->id); ?>"/>
									<input type="hidden" id="menu_id_edit" name="menu_id_edit" value=""/>
									<input type="hidden" id="action_change" name="action_change" value="<?php echo e(route('post-quick-edit')); ?>"/>                            
									<div class="form-group">
										<label class="col-lg-12 control-label" for="menu_name">Title menu</label>
										<div class="col-lg-12">   
											<?php echo e(Form::text('name', null, array('class'=>'bg-focus form-control', 'id'=>'menu_name'))); ?>
										...
										<div class="col-lg-12">   
											<select id="urlselectoption" class="bg-focus form-control" onchange="$('#menu_url').val($(this).val())">
												<optgroup label="Trang chủ">
													<option value="">---------------------------</option>
													<option value="<?php echo e(asset('')); ?>">Trang chủ</option>	
													<option value="<?php echo e(route('contact')); ?>">Liên hệ</option>	
													<option value="<?php echo e(route('contact')); ?>">Tin tức</option>	
													<option value="<?php echo e(route('project')); ?>">Dự án</option>	
													<option value="<?php echo e(route('product')); ?>">Sản phẩm</option>	
													<option value="<?php echo e(route('about')); ?>">Giới thiệu</option>	
												</optgroup> 
												<optgroup label="Dịch vụ">
													<?php if(isset($services) && count($services)>0): ?>
													<?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
													<option value="<?php echo e(route('services',$item->slug)); ?>"><?php echo e($item->name); ?></option>													
													
													<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
													<?php endif; ?>
												</optgroup>
												<optgroup label="Sản phẩm">
													<?php if(isset($pcate) && count($pcate)>0): ?>
													<?php $__currentLoopData = $pcate; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
													<option value="<?php echo e(route('product_cate',$item->slug)); ?>"><?php echo e($item->name); ?></option>													
												...
												<optgroup label="Tin tức">
													...
													<option value="<?php echo e(route('news_cate',$item->slug)); ?>"><?php echo e($item->name); ?></option>													
												...
												<optgroup label="Trang tĩnh">
													...
													<option value="<?php echo e(route('page',$item->slug)); ?>"><?php echo e($item->name); ?></option>													
									...
									<div class="form-group">
										...
										<div class="col-lg-12" style="margin-bottom:10px;">   
											<?php echo e(Form::text('url', null, array('class'=>'bg-focus form-control', 'id'=>'menu_url'))); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("admin.layout.hometemplate", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\wamp64\www\htc\resources\views/admin/menu/edit.blade.php ENDPATH**/ ?>