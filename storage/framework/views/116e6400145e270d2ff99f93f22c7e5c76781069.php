...
<script>
	...
	function fill_datatable(filter_status = '') {
		var table = $('#example').DataTable({
			...
			ajax: {
				url: "<?php echo e(route('post-data-customer')); ?>",
				type: "POST",
				data: {
...
<div class="container-fluid">
	<div class="page-header">
		<div class="row">
			...
			<div class="col-sm-6">
				<a href="<?php echo e(route('add-customer')); ?>" class="btn btn-primary w-md">Thêm</a>
			</div>
		</div>
	</div>
</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("admin.layout.hometemplate", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\htc\resources\views/admin/customer/view.blade.php ENDPATH**/ ?>