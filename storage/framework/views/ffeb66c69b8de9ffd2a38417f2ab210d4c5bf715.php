						...
						<div class="row">
							...
							<div class="col-12 col-lg-12">
								<div class="mb-3">
									...
									<?php echo e(Form::textarea('setting_product',isset($data->setting_product) ? $data->setting_product: '',array('class'=>'form-control tinymce_editor'))); ?>						
								</div>
							</div>
						</div>
					</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("admin.layout.hometemplate", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\wamp64\www\htc\resources\views/admin/setting/website.blade.php ENDPATH**/ ?>