							...
							<div class="card-body">
								...
								<div class="row">	
									<div class="col-12 col-lg-12">
										<div class="mb-3">
											<label class="form-label">Ảnh 360x360</label>	
											<input style="display:none" class="form-control file_upload_server_custom" id="label_modal_avatar" type="file" data-w="360" data-h="360" data-id="avatar" data-url="<?php echo e(route('dashboard-upload-one')); ?>" accept="image/*">
									...
									<div class="col-12 col-lg-2">
										<div class="mb-3">
											...
											<?php echo e(Form::text('price',0,array('class'=>'form-control mask_number'))); ?>
									...
									<div class="col-12 col-lg-2">
										<div class="mb-3">
											...
											<?php echo e(Form::text('pprice',0,array('class'=>'form-control mask_number'))); ?>
									...
									<div class="col-12 col-lg-2">
										<div class="mb-3">
											...
											<?php echo e(Form::number('guarantee',1,array('class'=>'form-control'))); ?>
									...
									<div class="col-12 col-lg-12">
										<div class="mb-3">
											...
											<?php echo e(Form::text('description','',array('class'=>'form-control tinymce_editor','data-upload-url'=>route('dashboard-upload-multi')))); ?>
									...
									<div class="col-12 col-lg-6">
										<div class="mb-3">
											...
											<?php echo e(Form::text('specification','',array('class'=>'form-control tinymce_editor','data-upload-url'=>route('dashboard-upload-multi')))); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("admin.layout.hometemplate", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\wamp64\www\baohanh\resources\views/admin/product/add.blade.php ENDPATH**/ ?>