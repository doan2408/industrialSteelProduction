							...
							<div class="row">	
								...
								<div class="col-12 col-lg-12">
									<div class="mb-3">
										...
										<?php echo e(Form::text('full_name',$data->full_name,array('class'=>'form-control'))); ?>
								...
								<div class="col-12 col-lg-12">
									<div class="mb-3">
										...
										<?php echo e(Form::text('age',$data->age,array('class'=>'form-control'))); ?>
								...
								<div class="col-12 col-lg-12">
									<div class="mb-3">
										...
										<?php echo e(Form::text('class_name',$data->class_name,array('class'=>'form-control'))); ?>
								...
								<div class="col-12 col-lg-12">
									<div class="mb-3">
										...
										<?php echo e(Form::text('email',$data->email,array('class'=>'form-control'))); ?>
