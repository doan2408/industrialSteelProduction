...
<?php $__env->startSection('js'); ?>
    ...
    <script src="<?php echo e(asset('assets/admin')); ?>/assets/js/datepicker/date-time-picker/tempusdominus-bootstrap-4.min.js">
    </script>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid">
        <form class="form-wizard" method="post" action="<?php echo e(route('post-edit-student')); ?>" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <!-- start page title -->
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-lg-12">
                                            <div class="mb-3">
                                                <label class="form-label">Ảnh 100x100<img id="avatar_img"
                                                        src="<?php echo e($data->avatar); ?>" width="100px" /></label>
                                                <input style="display:none" class="form-control file_upload_server_custom"
                                                    id="label_avatar" type="file" data-img="avatar_img" data-id="avatar"
                                                    data-url="<?php echo e(route('dashboard-upload-one')); ?>" accept="image/*">
                                                <div class="input-group"><label style="margin-bottom:0px;"
                                                        class="input-group-text" for="label_avatar">Upload file</label>
                                                    <?php echo e(Form::text('avatar', $data->avatar, ['class' => 'form-control input-group-air ', 'id' => 'avatar'])); ?>
                                        ...
                                        <div class="col-12 col-lg-12">
                                            <div class="mb-3">
                                                ...
                                                <?php echo e(Form::text('full_name', $data->full_name, ['class' => 'form-control'])); ?>
                                        ...
                                        <div class="col-12 col-lg-12">
                                            <div class="mb-3">
                                                <label class="col-form-label pt-0">Age</label>
                                                <?php echo e(Form::text('age', $data->age, ['class' => 'form-control'])); ?>
                                        ...
                                        <div class="col-12 col-lg-12">
                                            <div class="mb-3">
                                                <label class="col-form-label pt-0">Class name</label>
                                                <?php echo e(Form::text('class_name', $data->class_name, ['class' => 'form-control'])); ?>
                                        ...
                                        <div class="col-12 col-lg-12">
                                            <div class="mb-3">
                                                ...
                                                <?php echo e(Form::text('email', $data->email, ['class' => 'form-control'])); ?>
                                        ...
                                        <div class="col-12 col-lg-12">
                                            <div class="mb-3">
                                                ...
                                                <?php echo e(Form::select('status', ['0' => 'Không hoạt động', '1' => 'Hoạt động'], $data->status, [
                                                    'class' => 'form-control',
                                                ])); ?>
...
<?php echo $__env->make('admin.layout.hometemplate', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\htc\resources\views/admin/students/edit.blade.php ENDPATH**/ ?>