...
<div class="container-fluid">
	<form class="form-wizard" method="post" action="<?php echo e(route('post-add-page')); ?>" enctype="multipart/form-data">
		<?php echo csrf_field(); ?>
										...
										<div class="mb-3">
											...
											<div class="fileinput fileinput-new" data-provides="fileinput">
												<div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
													<img src="<?php echo e(asset('assets/admin')); ?>/assets/images/noimage.png" alt="" />
												</div>
												...
												<div>
													<span class="btn default btn-file">
														...
														<input type="file" name="fb_image"> </span>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("admin.layout.hometemplate", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\htc\resources\views/admin/page/add.blade.php ENDPATH**/ ?>