...
<div class="container-fluid">
	<form class="form-wizard" method="post" action="<?php echo e(route('post-edit-news')); ?>" enctype="multipart/form-data">
							<?php echo csrf_field(); ?>
	<!-- start page title -->
							...
							<div class="row">
								...
								<div class="col-12 col-lg-4">
									<div class="mb-3">
										...
										<div class="input-group date" id="dt-enab-disab-date" data-target-input="nearest">
											<input name="timepost" value="<?php echo e(date('d/m/Y H:i:s',$data->timepost)); ?>" class="form-control datetimepicker-input digits" type="text" data-target="#dt-enab-disab-date">
								...
								<div class="col-12 col-lg-8">
									<div class="mb-3">
										...
										<select class="js-example-placeholder-multiple" name="cate_id">
											...
											<option value="<?php echo e($item->id); ?>" <?php if($item->id == $data->cate_id): ?> selected <?php endif; ?>><?php echo e($item->name); ?></option>
												...
												<option value="<?php echo e($item1->id); ?>" <?php if($item1->id == $data->cate_id): ?> selected <?php endif; ?>>-<?php echo e($item1->name); ?></option>
												<?php endif; ?>
								...
								<div class="col-12 col-lg-12">
									<div class="mb-3">
										...
										<?php echo e(Form::text('tags',$data->tags,array('class'=>'form-control tags_input'))); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("admin.layout.hometemplate", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\wamp64\www\htc\resources\views/admin/news/edit.blade.php ENDPATH**/ ?>