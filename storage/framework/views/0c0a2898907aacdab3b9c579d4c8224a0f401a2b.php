...
<div class="container-fluid">
	<form class="form-wizard" method="post" action="<?php echo e(route('post-add-student')); ?>" enctype="multipart/form-data">
		<?php echo csrf_field(); ?>
								...
								<div class="row">			
									...
									<div class="col-12 col-lg-6">
										<div class="mb-3">
											...
											<?php echo e(Form::text('full_name','',array('class'=>'form-control'))); ?>
									...
									<div class="col-12 col-lg-6">
										<div class="mb-3">
											<label class="col-form-label pt-0">Tuổi</label>
											<?php echo e(Form::text('age','',array('class'=>'form-control'))); ?>
									...
									<div class="col-12 col-lg-6">
										<div class="mb-3">
											...
											<?php echo e(Form::text('class_name','',array('class'=>'form-control'))); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("admin.layout.hometemplate", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\htc\resources\views/admin/students/add.blade.php ENDPATH**/ ?>