...
<div class="alert alert-success alert-dismissible fade show mb-10" role="alert">
	...
	<?php echo e(Session::get('admin_notify_success')); ?>	
</div>
<?php } ?>
...
<div class="alert alert-danger alert-dismissible fade show mb-10" role="alert">
	...
	<?php echo e(Session::get('admin_notify_error')); ?>	
</div>
<?php } ?>
...
<?php } ?><?php /**PATH F:\wamp64\www\baohanh\resources\views/admin/alert.blade.php ENDPATH**/ ?>