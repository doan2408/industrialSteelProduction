...
<div class="container-fluid">
	<form class="form-wizard" method="post" action="<?php echo e(route('post-add-timeline')); ?>" enctype="multipart/form-data">
		<?php echo csrf_field(); ?>
								...
								<div class="row">
									...
									<div class="col-12 col-lg-6">
										<div class="mb-3">
											...
											<?php echo e(Form::text('year',date('d/m/Y'),array('class'=>'form-control datepicker-here form-control digits','data-language'=>'en'))); ?>
									...
									<div class="col-12 col-lg-12">
										<div class="mb-3">
											...
											<?php echo e(Form::textarea('content','',array('class'=>'form-control'))); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("admin.layout.hometemplate", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\wamp64\www\htc\resources\views/admin/timeline/add.blade.php ENDPATH**/ ?>