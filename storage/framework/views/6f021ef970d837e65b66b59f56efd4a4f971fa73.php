...
<!-- Plugins JS start-->
<script src="<?php echo e(asset('assets/admin')); ?>/assets/js/height-equal.js"></script>
    ...
    <div class="page-header">
        <div class="row">
            <div class="col-sm-6">
                <h3>Alert</h3>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<?php echo e(asset('dashboard')); ?>">Trang chủ</a></li>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("admin.layout.hometemplate", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\htc\resources\views/admin/index.blade.php ENDPATH**/ ?>