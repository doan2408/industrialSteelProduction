...
<div class="container-fluid">
	<form class="form-wizard" method="post" action="<?php echo e(route('post-add-product-cate')); ?>" enctype="multipart/form-data">
		<?php echo csrf_field(); ?>
								...
								<div class="row">
									...
									<div class="col-12 col-lg-12">
										<div class="mb-3">
											...
											<?php echo e(Form::textarea('content','',array('class'=>'form-control tinymce_editor'))); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("admin.layout.hometemplate", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\wamp64\www\htc\resources\views/admin/product/category/add.blade.php ENDPATH**/ ?>