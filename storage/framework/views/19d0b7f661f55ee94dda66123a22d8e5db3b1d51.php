					...
					<div class="card-body">
						...
						<div class="row">
							...
							<div class="col-12 col-lg-12">
								<div class="mb-3">
									<label class="form-label">Ảnh sứ mệnh 345x258 <img src="<?php if(isset($data->website_about1)): ?><?php echo e($data->website_about1); ?><?php endif; ?>" width="100px" id="img_website_about1"/></label>	
									<input style="display:none" class="form-control file_upload_server_custom" id="label_website_about1" type="file" data-img="img_website_about1" data-id="website_about1" data-url="<?php echo e(route('dashboard-upload-one')); ?>" accept="image/*">
									<div class="input-group"><label style="margin-bottom:0px;" class="input-group-text" for="label_website_about1">Upload file</label>
										<?php echo e(Form::text('website_about1',isset($data->website_about1) ? $data->website_about1: '',array('class'=>'form-control input-group-air ','id'=>'website_about1'))); ?>
							...
							<div class="col-12 col-lg-12">
								<div class="mb-3">
									...
									<?php echo e(Form::text('setting_about2',isset($data->setting_about2) ? $data->setting_about2: '',array('class'=>'form-control tinymce_editor'))); ?>						
								</div>
							</div>
							<div class="col-12 col-lg-12">
								<div class="mb-3">
									<label class="form-label">Ảnh tầm nhìn 345x258 <img src="<?php if(isset($data->website_about3)): ?><?php echo e($data->website_about3); ?><?php endif; ?>" width="100px" id="img_website_about3"/></label>	
									<input style="display:none" class="form-control file_upload_server_custom" id="label_website_about3" type="file" data-img="img_website_about3" data-id="website_about3" data-url="<?php echo e(route('dashboard-upload-one')); ?>" accept="image/*">
									<div class="input-group"><label style="margin-bottom:0px;" class="input-group-text" for="label_website_about3">Upload file</label>
										<?php echo e(Form::text('website_about3',isset($data->website_about3) ? $data->website_about3: '',array('class'=>'form-control input-group-air ','id'=>'website_about3'))); ?>
							...
							<div class="col-12 col-lg-12">
								<div class="mb-3">
									...
									<?php echo e(Form::text('setting_about4',isset($data->setting_about4) ? $data->setting_about4: '',array('class'=>'form-control tinymce_editor'))); ?>						
								</div>
							</div>
							<div class="col-12 col-lg-12">
								<div class="mb-3">
									<label class="form-label">Ảnh tôn chỉ 345x258 <img src="<?php if(isset($data->website_about5)): ?><?php echo e($data->website_about5); ?><?php endif; ?>" width="100px" id="img_website_about5"/></label>	
									<input style="display:none" class="form-control file_upload_server_custom" id="label_website_about5" type="file" data-img="img_website_about5" data-id="website_about5" data-url="<?php echo e(route('dashboard-upload-one')); ?>" accept="image/*">
									<div class="input-group"><label style="margin-bottom:0px;" class="input-group-text" for="label_website_about5">Upload file</label>
										<?php echo e(Form::text('website_about5',isset($data->website_about5) ? $data->website_about5: '',array('class'=>'form-control input-group-air ','id'=>'website_about5'))); ?>
							...
							<div class="col-12 col-lg-12">
								<div class="mb-3">
									...
									<?php echo e(Form::text('setting_about6',isset($data->setting_about6) ? $data->setting_about6: '',array('class'=>'form-control tinymce_editor'))); ?>						
								</div>
							</div>
							<div class="col-12 col-lg-12">
								<div class="mb-3">
									<label class="form-label">Dấu mốc lịch sử</label>						
									<?php echo e(Form::textarea('setting_about7',isset($data->setting_about7) ? $data->setting_about7: '',array('class'=>'form-control'))); ?>						
								</div>
							</div>
						</div>
					</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("admin.layout.hometemplate", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\wamp64\www\htc\resources\views/admin/setting/about.blade.php ENDPATH**/ ?>