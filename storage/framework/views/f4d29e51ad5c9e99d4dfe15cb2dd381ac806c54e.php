		...
		<div class="row">
			<div class="col-sm-6">
				...
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item"><a href="<?php echo e(route('view-services')); ?>">Dịch vụ</a></li>
...
<div class="container-fluid">
	<form class="form-wizard" method="post" action="<?php echo e(route('post-add-services')); ?>" enctype="multipart/form-data">
		<?php echo csrf_field(); ?>
							...
							<div class="card-body">
								...
								<div class="row">
									<div class="col-12 col-lg-12">
										<div class="mb-3">
											<label class="form-label">Ảnh 64x64 <img id="avatar_img" src="" width="100px"/></label>	
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("admin.layout.hometemplate", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\htc\resources\views/admin/services/add.blade.php ENDPATH**/ ?>