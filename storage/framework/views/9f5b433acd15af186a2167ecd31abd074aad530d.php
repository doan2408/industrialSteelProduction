...
<script>
	...
	function fill_datatable() {
		var table = $('#example').DataTable({
			...
			ajax: {
				url: "<?php echo e(route('post-data-contact')); ?>",
				type: "POST",
				data: {
		...
		<div class="row">
			<div class="col-sm-6">
				...
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item"><a href="<?php echo e(route('view-contact')); ?>">Liên hệ</a></li>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("admin.layout.hometemplate", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\wamp64\www\htc\resources\views/admin/contact/view.blade.php ENDPATH**/ ?>