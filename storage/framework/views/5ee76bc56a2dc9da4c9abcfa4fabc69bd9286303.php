...
<div class="container-fluid">
	<form class="form-wizard" method="post" action="<?php echo e(route('post-add-news')); ?>" enctype="multipart/form-data">
		<?php echo csrf_field(); ?>
								...
								<div class="row">
									...
									<div class="col-12 col-lg-4">
										<div class="mb-3">
											...
											<div class="input-group date" id="dt-enab-disab-date" data-target-input="nearest">
												<input name="timepost" value="<?php echo e(date('d/m/Y H:i:s',time())); ?>" class="form-control datetimepicker-input digits" type="text" data-target="#dt-enab-disab-date">
									...
									<div class="col-12 col-lg-12">
										<div class="mb-3">
											...
											<?php echo e(Form::text('tags','',array('class'=>'form-control tags_input'))); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("admin.layout.hometemplate", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\htc\resources\views/admin/news/add.blade.php ENDPATH**/ ?>