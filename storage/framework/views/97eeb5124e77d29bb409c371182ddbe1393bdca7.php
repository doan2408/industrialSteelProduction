...
<div class="container-fluid">
	<form class="form-wizard" method="post" action="<?php echo e(route('post-add-project')); ?>" enctype="multipart/form-data">
		<?php echo csrf_field(); ?>
								...
								<div class="row">
									...
									<div class="col-12 col-lg-3">
										<div class="mb-3">
											...
											<?php echo e(Form::text('client','',array('class'=>'form-control'))); ?>
									...
									<div class="col-12 col-lg-3">
										<div class="mb-3">
											...
											<?php echo e(Form::text('dimension','',array('class'=>'form-control'))); ?>
									...
									<div class="col-12 col-lg-3">
										<div class="mb-3">
											...
											<?php echo e(Form::text('type','',array('class'=>'form-control'))); ?>
									...
									<div class="col-12 col-lg-12">
										<div class="mb-3">
											...
											<?php echo e(Form::textarea('content','',array('class'=>'form-control tinymce_editor','data-upload-url'=>route('dashboard-upload-multi')))); ?>
									...
									<div class="col-12 col-lg-12">
										<div class="mb-3">
											...
											<div class="input-group"><label style="margin-bottom:0px;" class="input-group-text" for="label_modal_image1">Upload file</label>
												<?php echo e(Form::text('image1','',array('class'=>'form-control input-group-air ','id'=>'image1'))); ?>
									...
									<div class="col-12 col-lg-12">
										<div class="mb-3">
											...
											<div class="input-group"><label style="margin-bottom:0px;" class="input-group-text" for="label_modal_image2">Upload file</label>
												<?php echo e(Form::text('image2','',array('class'=>'form-control input-group-air ','id'=>'image2'))); ?>
									...
									<div class="col-12 col-lg-12">
										<div class="mb-3">
											...
											<div class="input-group"><label style="margin-bottom:0px;" class="input-group-text" for="label_modal_image3">Upload file</label>
												<?php echo e(Form::text('image3','',array('class'=>'form-control input-group-air ','id'=>'image3'))); ?>
									...
									<div class="col-12 col-lg-12">
										<div class="mb-3">
											...
											<div class="input-group"><label style="margin-bottom:0px;" class="input-group-text" for="label_modal_image4">Upload file</label>
												<?php echo e(Form::text('image4','',array('class'=>'form-control input-group-air ','id'=>'image4'))); ?>
									...
									<div class="col-12 col-lg-12">
										<div class="mb-3">
											...
											<div class="input-group"><label style="margin-bottom:0px;" class="input-group-text" for="label_modal_image5">Upload file</label>
												<?php echo e(Form::text('image5','',array('class'=>'form-control input-group-air ','id'=>'image5'))); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("admin.layout.hometemplate", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\wamp64\www\htc\resources\views/admin/project/add.blade.php ENDPATH**/ ?>