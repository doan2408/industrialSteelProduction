...
<script>
	...
	function fill_datatable(filter_status = '') {
		var table = $('#example').DataTable({
			...
			ajax: {
				url: "<?php echo e(route('post-data-product')); ?>",
				type: "POST",
				data: {
...
<div class="container-fluid">
	<div class="page-header">
		<div class="row">
			...
			<div class="col-sm-6">
				<a href="<?php echo e(route('add-product')); ?>" class="btn btn-primary w-md">Thêm</a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("admin.layout.hometemplate", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\wamp64\www\baohanh\resources\views/admin/product/view.blade.php ENDPATH**/ ?>