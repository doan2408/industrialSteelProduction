		...
		<div class="row">
			<div class="col-sm-6">
				...
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item"><a href="<?php echo e(route('view-department')); ?>">Phòng ban</a></li>
...
<div class="container-fluid">
	<form class="form-wizard" method="post" action="<?php echo e(route('post-edit-department')); ?>" enctype="multipart/form-data">
							<?php echo csrf_field(); ?>
	<!-- start page title -->
							...
							<div class="row">	
								...
								<div class="col-12 col-lg-6">
									<div class="mb-3">
										...
										<?php echo e(Form::text('phone',$data->phone,array('class'=>'form-control'))); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("admin.layout.hometemplate", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\wamp64\www\htc\resources\views/admin/department/edit.blade.php ENDPATH**/ ?>