				...
				<div class="row">
					<div class="col-12 col-lg-4">
						<div class="mb-3">
							...
							<?php echo e(Form::text('setting_phone',isset($data->setting_phone) ? $data->setting_phone: '',array('class'=>'form-control'))); ?>						
						</div>
					</div>
					<div class="col-12 col-lg-4">
						<div class="mb-3">
							<label class="form-label">Email</label>						
							<?php echo e(Form::text('setting_email',isset($data->setting_email) ? $data->setting_email: '',array('class'=>'form-control'))); ?>						
						</div>
					</div>
					<div class="col-12 col-lg-4">
						<div class="mb-3">
							<label class="form-label">Zalo</label>						
							<?php echo e(Form::text('setting_zalo',isset($data->setting_zalo) ? $data->setting_zalo: '',array('class'=>'form-control'))); ?>						
						</div>
					</div>
					<div class="col-12 col-lg-4">
						<div class="mb-3">
							<label class="form-label">Địa chỉ nhà máy 1</label>						
							<?php echo e(Form::text('setting_address1',isset($data->setting_address1) ? $data->setting_address1: '',array('class'=>'form-control'))); ?>						
						</div>
					</div>
					<div class="col-12 col-lg-4">
						<div class="mb-3">
							<label class="form-label">Hotline nhà máy 1</label>						
							<?php echo e(Form::text('setting_hotline1',isset($data->setting_hotline1) ? $data->setting_hotline1: '',array('class'=>'form-control'))); ?>						
						</div>
					</div>
					<div class="col-12 col-lg-4">
						<div class="mb-3">
							<label class="form-label">Link map nhà máy 1</label>						
							<?php echo e(Form::text('setting_map1',isset($data->setting_map1) ? $data->setting_map1: '',array('class'=>'form-control'))); ?>						
						</div>
					</div>
					<div class="col-12 col-lg-4">
						<div class="mb-3">
							<label class="form-label">Địa chỉ nhà máy 2</label>						
							<?php echo e(Form::text('setting_address2',isset($data->setting_address2) ? $data->setting_address2: '',array('class'=>'form-control'))); ?>						
						</div>
					</div>
					<div class="col-12 col-lg-4">
						<div class="mb-3">
							<label class="form-label">Hotline nhà máy 2</label>						
							<?php echo e(Form::text('setting_hotline2',isset($data->setting_hotline2) ? $data->setting_hotline2: '',array('class'=>'form-control'))); ?>						
						</div>
					</div>
					<div class="col-12 col-lg-4">
						<div class="mb-3">
							<label class="form-label">Link map nhà máy 2</label>						
							<?php echo e(Form::text('setting_map2',isset($data->setting_map2) ? $data->setting_map2: '',array('class'=>'form-control'))); ?>						
						</div>
					</div>
					<div class="col-12 col-lg-4">
						<div class="mb-3">
							<label class="form-label">Facebook</label>						
							<?php echo e(Form::text('setting_facebook',isset($data->setting_facebook) ? $data->setting_facebook: '',array('class'=>'form-control'))); ?>						
						</div>
					</div>
					<div class="col-12 col-lg-4">
						<div class="mb-3">
							<label class="form-label">Google</label>						
							<?php echo e(Form::text('setting_google',isset($data->setting_google) ? $data->setting_google: '',array('class'=>'form-control'))); ?>						
						</div>
					</div>
					<div class="col-12 col-lg-4">
						<div class="mb-3">
							<label class="form-label">Linkedin</label>						
							<?php echo e(Form::text('setting_linkedin',isset($data->setting_linkedin) ? $data->setting_linkedin: '',array('class'=>'form-control'))); ?>						
						</div>
					</div>
					<div class="col-12 col-lg-4">
						<div class="mb-3">
							<label class="form-label">Instagram</label>						
							<?php echo e(Form::text('setting_instagram',isset($data->setting_instagram) ? $data->setting_instagram: '',array('class'=>'form-control'))); ?>						
						</div>
					</div>
					<div class="col-12 col-lg-4">
						<div class="mb-3">
							<label class="form-label">Twitter</label>						
							<?php echo e(Form::text('setting_twitter',isset($data->setting_twitter) ? $data->setting_twitter: '',array('class'=>'form-control'))); ?>						
						</div>
					</div>
					<div class="col-12 col-lg-12">
						<div class="mb-3">
							<label class="form-label">Bản đồ</label>						
							<?php echo e(Form::textarea('setting_map',isset($data->setting_map) ? $data->setting_map: '',array('class'=>'form-control'))); ?>						
						</div>
					</div>
					<div class="col-12 col-lg-12">
						<div class="mb-4">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("admin.layout.hometemplate", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\htc\resources\views/admin/setting/general.blade.php ENDPATH**/ ?>