<header class="main-nav">
    ...
    <div class="main-navbar">
        ...
        <ul class="nav-menu custom-scrollbar">
			...
			<li><a class="nav-link menu-title link-nav" href="<?php echo e(route('view-serial')); ?>"><i data-feather="edit"></i><span>Serial</span></a></li>
			...
			<li><a class="nav-link menu-title link-nav" href="<?php echo e(route('view-attributes')); ?>"><i data-feather="edit"></i><span>Thuộc tính</span></a></li>
			...
			<li><a class="nav-link menu-title link-nav" href="<?php echo e(route('view-contact')); ?>"><i data-feather="edit"></i><span>Liên hệ</span></a></li>
			<li><a class="nav-link menu-title link-nav" href="<?php echo e(route('view-faq')); ?>"><i data-feather="edit"></i><span>Faq</span></a></li>
			<li><a class="nav-link menu-title link-nav" href="<?php echo e(route('view-extend')); ?>"><i data-feather="edit"></i><span>Gia hạn bảo hành</span></a></li>
			<li><a class="nav-link menu-title link-nav" href="<?php echo e(route('view-order')); ?>"><i data-feather="edit"></i><span>Đơn hàng</span></a></li>
			...
			<li><a class="nav-link menu-title link-nav" href="<?php echo e(route('view-user')); ?>"><i data-feather="edit"></i><span>Đại lý</span></a></li>
            <li class="sidebar-main-title">
            <div>
                <h6>Cấu hình            </h6>
            </div>
...
<?php /**PATH F:\wamp64\www\baohanh\resources\views/admin/layout/left.blade.php ENDPATH**/ ?>