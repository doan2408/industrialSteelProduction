...
if (!defined('MAX_WIDTH'))
    define('MAX_WIDTH', 7000);        // Maximum image width
if (!defined('MAX_HEIGHT'))
    define('MAX_HEIGHT', 7000);       // Maximum image height
...
class ImageCropResize extends Model {
...
//            $config_all = \ADMINMODEL\tblSettingModel::find(1);
//            $config_all = json_decode($config_all->data);
//            $this->src = $config_all->website_image_default;
//        }
    ...
    protected function setMemoryLimit() {
        ...
        $inibytes = ImageCropResize::returnBytes($inimem);
        $ourbytes = ImageCropResize::returnBytes(MEMORY_LIMIT);
    ...
    protected function getURL($url, $tempfile) {
        ...
        if (function_exists('curl_init')) {
            ...
            curl_setopt($curl, CURLOPT_WRITEFUNCTION, 'ImageCropResize::curlWrite');
